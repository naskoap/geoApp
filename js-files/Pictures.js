var pictureArrayU = ['<img src="SewaneePictures/University/fulford.JPG" class="pic">',
                     '<img src="SewaneePictures/University/downtown.JPG" class="pic">',
                     '<img src="SewaneePictures/University/mcclurg.JPG" class="pic">',
                     '<img src="SewaneePictures/University/allsaints.JPG" class="pic">',
                     '<img src="SewaneePictures/University/bookstore.JPG" class="pic">',
                     '<img src="SewaneePictures/University/stirlings.JPG" class="pic">',
                     '<img src="SewaneePictures/University/thompson.JPG" class="pic">',
                     '<img src="SewaneePictures/University/fowler.JPG" class="pic">',
                     '<img src="SewaneePictures/University/careerservices.JPG" class="pic">',
                     ...
                     '<img src="SewaneePictures/University/cravens.JPG" class="pic">',
                     '<img src="SewaneePictures/University/farm.JPG" class="pic">',
...
var pictureArrayD = ['<img src="SewaneePictures/Dorms/cannon.jpg" class="pic">',
                     ...
                     '<img src="SewaneePictures/Dorms/spanish.jpg" class="pic">',
                     '<img src="SewaneePictures/Dorms/german.jpg" class="pic">'];

var pictureArrayA = ['<img src="SewaneePictures/Academic/woods.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/walsh.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/carnegie.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/gailor.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/spencer.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/guerry.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/snowden.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/library.jpg" class="pic">',
                     '<img src="SewaneePictures/Academic/nabit.jpg" class="pic">'];
